...
public class MainController extends AbsctractController {
    ...
    @FXML
    private BorderPane bpResearchPane;
    @FXML
    private BorderPane bpQuestionPane;
    @FXML
    private BorderPane bpAnswerPane;
    @FXML
    private BorderPane bpImportPane;
    @FXML
    private BorderPane bpExportPane;
    @FXML
    private BorderPane bpReportPane;
    @FXML
    private BorderPane bpSpecificReportPane;
    @FXML
    private Button btnResearchAdd;
    @FXML
    private Button btnResearchUpdate;
    @FXML
    ...
    @FXML
    private Button btnBackToResearchs;
    @FXML
    private Button btnResearchEdit;
    @FXML
    private Button btnReportAdd;
    @FXML
    private Button btnReportUpdate;
    @FXML
    private VBox vbResearchs;
    @FXML
    private VBox vbReports;
    @FXML
    private VBox vbQuestions;
    @FXML
    private VBox vbReportComponent;
    @FXML
    private Label lblResearchTitle;
    @FXML
    private TextArea taResearchDescription;
    @FXML
    private Label lblQuestionTitle;
    @FXML
    private Button btnBackToQuestions;
    @FXML
    private TableView<Answer> tvAnswers;
    @FXML
    private TableColumn<Answer, String> tcAnswer;
    @FXML
    ...
    @FXML
    private Button btnExportSelect;
    @FXML
    private Button btnDoExport;
    @FXML
    private ListView<String> lvExportResearchs;
    @FXML
    private Button btnComponentAdd;
    @FXML
    private Button btnQuestionEdit;
    @FXML
    private Button btnAnswerDelete;
    @FXML
    private Button btnQuestionAnswers;
    @FXML
    private Label lblSpecificReport;
    @FXML
    ...
    @FXML
    private Button btnDBAnswer;
    @FXML
    private Button btnDBCollect;
    @FXML
    private BorderPane bpOnlinePane;
    @FXML
    private Button btnOnline;
    @FXML
    private Button btnReportDelete;
    @FXML
    private Button btnSpecificReportBack;
    @FXML
    private Button btnSpecificReportUpdate;
    @FXML
    private Label lblOnlineWarning;
